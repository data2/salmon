 ...
 */
package com.barnett.db.engine.inner.co.impl;
...
import com.barnett.db.config.DicoConfig;
import com.barnett.db.config.KeysConstant;
import com.barnett.db.engine.factory.BuildFactory;
import com.barnett.db.engine.inner.co.Co;
import com.barnett.db.engine.inner.sql.DicoSql;
import com.barnett.db.engine.inner.trans.impl.DicoTrans;
import com.barnett.db.engine.parser.ParseConfig;
...
public class Dico implements Co{
    ...
    private String getDicoFile() {
        return DicoClassLoader.getCurrClassName().replaceAll("\\.", "/")
                .concat(".co");
    }
