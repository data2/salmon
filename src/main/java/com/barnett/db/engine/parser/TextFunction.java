...
import com.barnett.db.util.StringUtils;
...
public class TextFunction {
    ...
    public static void main(String[] args) throws IOException, InnerException {
        String contents = Resources.toString(DicoClassLoader.getClassLoader()
                .getResource("com/barnett/db/engine/inner/Test.co"),
                Charsets.UTF_8);
