...
public class Dico implements Co {
    ...
    public Dico select(String sqlId) {
        this.currSql = new DicoSql(OperationKeys.SELECT, sqlId);
        return this;
    }

    public Dico insert(String sqlId) {
        this.currSql = new DicoSql(OperationKeys.INSERT, sqlId);
        return this;
    }

    public Dico update(String sqlId) {
        this.currSql = new DicoSql(OperationKeys.UPDATE, sqlId);
        return this;
    }

    public Dico delete(String sqlId) {
        this.currSql = new DicoSql(OperationKeys.DELETE, sqlId);
        return this;
    }
