...
public class TableRulerBean {
    ...
    public TableRulerBean(String name, String column, String val, String partionMethod, String[] params) {
        super();
        this.name = name;
        this.column = column;
        this.val = val;
    ...
    public String toString() {
        return "TableRulerBean [name=" + name + ", column=" + column + ", val=" + val + ", partionMethod="
                + partionMethod + ", params=" + Arrays.toString(params) + "]";
    }
